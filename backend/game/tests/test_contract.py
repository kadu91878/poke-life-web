...
class TestSocketActionContract(TestCase):
    ...
    def test_frontend_store_uses_shared_action_contract(self):
        ...
        self.assertIn("send(gameActions.debugToggleTestPlayer", store_source)
        self.assertIn("send(gameActions.debugMoveTestPlayer", store_source)
        ...
        self.assertIn("store.actions.debugToggleTestPlayer", board_source)
        self.assertIn("store.actions.debugMoveTestPlayer", board_source)
        self.assertIn("store.actions.debugRollTestPlayer", board_source)
        self.assertIn("store.actions.debugTriggerTestPlayerTile", board_source)
        self.assertIn("store.actions.debugRollCaptureForTestPlayer", board_source)
        self.assertIn("store.actions.debugResolveEventForTestPlayer", board_source)
        self.assertIn("store.actions.debugSkipTestPlayerPending", board_source)
        self.assertIn("v-if=\"debugEnabled && debugTestPlayer\"", board_source)
        self.assertIn("debugInventoryOpen", board_source)
